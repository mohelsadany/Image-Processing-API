...
var requestMainEndpoint = (0, supertest_1.default)(__1.default);
//create our suite
describe('testing our mainEndpoint middleware endpoint', function () {
    //create it block with async function as superTest need
    it('testing the server status using superTest', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, requestMainEndpoint.get('/image/?filename=image&width=750&height=750')];
                case 1:
                    response = _a.sent();
